...
import com.ultima.coe.common.ProgressBar;
...
public class CampfireGuiOld extends GuiBase {
	...
	public CampfireGuiOld(Container container, InventoryPlayer playerInv) {
		super(container);
